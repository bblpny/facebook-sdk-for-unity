...
namespace Facebook.Unity.Internal
{
    ...
    using UnityEngine;
	using FB = InternalFB;
	using IMobileFacebook = Mobile.IMobileFacebook;

    /// <summary>
    /// Static class for exposing the facebook integration.
    /// </summary>
    public abstract class InternalFB : ScriptableObject
    {
        protected const string DefaultJSSDKLocale = "en_US";
            ...
            InitDelegate onInitComplete)
        {
			if (null == platform)
			{
				throw new System.ArgumentNullException("platform cannot be null");
			}
            ...
            {
                isInitCalled = true;
				FB.OnDLLLoadedDelegate = platform.Install(appId, cookie, logging, status, xfbml, frictionlessRequests, authResponse, javascriptSDKLocale, onHideUnity, onInitComplete);
				platform.GetLoader();
            }
            else
            {
        ...
        public sealed class Mobile
        {
            ...
            {
				Mobile.MobileFacebookImpl.AppInvite(appLinkUrl, previewImageUrl, callback);
            }
			...
			public static string KeyHash
			{
				get
				{
					return Mobile.MobileFacebookImpl.KeyHash ?? string.Empty;
				}
			}
		}
        ...
        public sealed class Android
        {
			...
			/// </summary>
			/// <value>The key hash.</value>
			[Obsolete("Use FB.Mobile.KeyHash")]
			public static string KeyHash
            {
                get
                {
                    var androidFacebook = FacebookImpl as IMobileFacebook;
        ...
        public abstract class CompiledFacebookLoader : MonoBehaviour
        {
            ...
            public void Start()
            {
                ...
                FB.OnDLLLoadedDelegate(FB.facebook);
                FB.LogVersion();
	...
	public delegate void OnDLLLoaded(Internal.IFacebook facebook);
}
